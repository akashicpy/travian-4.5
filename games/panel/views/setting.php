    ...
    <div class="card-body">
        ...
        if (isset($_POST['update'])) {
            if (
                ...
                header('Location: index.php?p=setting&d');
            }
        }
        ...
        <form action="" method="post">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="SERVER_NAME" type="text" value="<?php echo SERVER_NAME; ?>"
                        required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label>storage</label>
                    <input class="form-control" name="STORAGE_MULTIPLIER" value="<?php echo STORAGE_MULTIPLIER; ?>"
                        required>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label>traps</label>
                    <input class="form-control" name="TRAPPER_CAPACITY" value="<?php echo TRAPPER_CAPACITY; ?>"
                        required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select name="MOMENT_TRAIN" class="form-control">
                        <option <?php if (MOMENT_TRAIN == 1) {
                            echo "selected";
                        } ?> value="1">yes</option>
                        <option <?php if (MOMENT_TRAIN == 0) {
                            echo "selected";
                        } ?> value="0">no</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <select name="PROTECTIOND" class="form-control">
                        <option <?php if (PROTECTIOND == 0) {
                            echo "selected";
                        } ?> value="1">No Protection</option>
                        <option <?php if (PROTECTIOND == 43200) {
                            echo "selected";
                        } ?> value="43200">12 hour</option>
                        <option <?php if (PROTECTIOND == 86400) {
                            echo "selected";
                        } ?> value="86400">24 hour</option>
                        <option <?php if (PROTECTIOND == 172800) {
                            echo "selected";
                        } ?> value="172800">2 days</option>
                        <option <?php if (PROTECTIOND == 259200) {
                            echo "selected";
                        } ?> value="259200">3 days</option>
                        <option <?php if (PROTECTIOND == 345600) {
                            echo "selected";
                        } ?> value="345600">4 days</option>
                        <option <?php if (PROTECTIOND == 432000) {
                            echo "selected";
                        } ?> value="432000">5 days</option>
                        <option <?php if (PROTECTIOND == 518400) {
                            echo "selected";
                        } ?> value="518400">6 days</option>
                        <option <?php if (PROTECTIOND == 604800) {
                            echo "selected";
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label>Medal reset</label>
                    <select name="MEDALS" class="form-control">
                        <option <?php if ($config['medalReset'] == 43200) {
                            echo "selected";
                        } ?> value="43200">12 hours
                        </option>
                        <option <?php if ($config['medalReset'] == 86400) {
                            echo "selected";
                        } ?> value="86400">1 day</option>
                        <option <?php if ($config['medalReset'] == 259200) {
                            echo "selected";
                        } ?> value="259200">3 days
                        </option>
                        <option <?php if ($config['medalReset'] == 604800) {
                            echo "selected";
                        } ?> value="604800">7 days
                        </option>
                    </select>
