...
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE build  <?php if ($dorf1 == '') {
                                    ...
                                    if ($village->resarray['f' . $_GET['id'] . 't'] == 0 && $_GET['id'] >= 19) {
                                        ...
                                        if (file_exists("application/views/Build/" . $village->resarray['f' . $_GET['id'] . 't'] . ".php")) {
                                            ...
                                            <h1 class="titleInHeader">
                                                <?= $lang['buildings'][$village->resarray['f' . $_GET['id'] . 't']] ?>
                                                <span class="level"> <?= LEVEL ?>                 <?= $village->resarray['f' . $id] ?></span>
                                            </h1>
                                            <div id="build"
                                                class="gid<?= $village->resarray['f' . $_GET['id'] . 't'] ?> level<?= $village->resarray['f' . $id] ?>">
