        ...
        if ($_POST['activeTab'] == 'buyGold') {
            ...
            $html .= '<div id="paymentWizard" class="paymentFeatures">
                ...
                <div class="contentBorder-contents cf">
                        ...
                        <a href="#" onclick="jQuery(\'.paymentWizardMenu\').addClass(\'hide\');jQuery(\'.buyGoldInfoStep\').removeClass(\'active\');jQuery(\'.buyGoldInfoStep#2\').addClass(\'active\');jQuery(\'.paymentWizardMenu#moreProtection\').removeClass(\'hide\');">
                        ...
                        ' .
                ($config['allowBuyRes']
                    ? '<a href="#" onclick="jQuery(\'.paymentWizardMenu\').addClass(\'hide\');jQuery(\'.buyGoldInfoStep\').removeClass(\'active\');jQuery(\'.buyGoldInfoStep#3\').addClass(\'active\');jQuery(\'.paymentWizardMenu#buyResources\').removeClass(\'hide\');">
