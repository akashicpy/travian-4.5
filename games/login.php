...
<body
    class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE login  perspectiveBuildings <?php echo DIRECTION; ?> season- buildingsV1">
    <div id="background">
                    ...
                    <div class="contentContainer">
                        <div id="content" class="login">
                            ...
                            <div class="outerLoginBox <?php echo @$loginform; ?>">
                                <h2><?php echo $lang['login']['Welcome'] . ' ';
                                echo SERVER_NAME . ' '; ?></h2>
                                <noscript>
                                        ...
                                        <table class="transparent loginTable">
                                            <tbody>
                                                <tr class="account">
                                                    ...
                                                    <td><input class="text" type="text" name="user" maxlength="35"
                                                            autocomplete='off' /> <span class="error">
                                                            <?php echo $form->getError("user"); ?></span></td>
                                                ...
                                                <tr class="pass">
                                                    ...
                                                    <td><input class="text" type="password" name="pw" maxlength="20"
                                                            autocomplete='off' />
                                                        <span
                                                            class="error"><br><?php echo $form->getError("pw"); ?></span>
                                                    </td>
                                                ...
                                                <tr class="lowResOption">
                                                    ...
                                                    <td colspan="2">
                                                        <input type="checkbox" class="checkbox" id="lowRes"
                                                            name="lowRes" value="">
                                                        <label
                                                            for="lowRes"><?php echo $lang['login']['Notice2']; ?></label>
                                                    </td>
                                                </tr>
                                                <tr class="lowResInfo">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit"
                                                            value="<?php echo $lang['login']['Login']; ?>" name="s2"
                                                            id="s2" class="green "
                            ...
                            <div class="greenbox passwordForgotten">
                                ...
                                <div class="greenbox-content">
                                    <div class="passwordForgottenLink">
                                        <a onClick="$('showPasswordForgotten').showOrHide('arrow');" href="<?php if (isset($_GET['action'])) {
                                            echo '#';
                                        } else {
                                            echo '?action=forgotPassword';
                                        } ?>" class="showPWForgottenLink">
                                            <img class="close" id="arrow"
                                                src="img/x.gif"><?php echo $lang['login']['ForgetPW1']; ?>
                                        </a>
                                    </div>
                                                ...
                                                <table class="transparent pwForgottenTable" id="pw_forgotten_form"
                                                    ...
                                                    <tbody>
                                                        <tr class="mail">
                                                            ...
                                                            <td>
                                                                <input class="text" type="text" name="pw_email"
                                                                    value=""><br>
                                                                <div class="error <?php echo DIRECTION; ?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <button type="submit"
                                                                    value="<?php echo $lang['login']['ForgetPW4']; ?>"
                                                                    name="s2" id="s2" class="green "
                                                                    onclick="document.login.w.value=screen.width+':'+screen.height;">
                                                                    <div class="button-container addHoverClick ">
                                                                        <div class="button-background">
                                                                            <div class="buttonStart">
