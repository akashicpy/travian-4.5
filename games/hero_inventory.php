...
<body class="v35 webkit <?= $database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> ar-AE hero hero_inventory <?php if ($dorf1 == '') {
				...
				<div id="contentOuterContainer" class="size1">
					...
					<div class="contentContainer">
						<div id="content" class="hero_inventory">
							<h1 class="titleInHeader"><?= $session->username ?> - <?php echo U0; ?>
								<?= LVL . "  " . $session->heroD['level'] ?>
							</h1>
							<?php
