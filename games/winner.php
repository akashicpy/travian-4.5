...
$sql = $database->query("SELECT username,alliance,tribe FROM users WHERE id = '" . $owner . "'");
            ...
            <div id="center">
                ...
                <div id="contentOuterContainer" class="size1">
                    ...
                    <div class="contentTitle"><a id="closeContentButton" class="contentTitleButton"
                        ...
                        <a id="answersButton" class="contentTitleButton" href="#" target="_blank"
                    ...
                    <div class="contentContainer">
                        <div id="content" class="plus">
                            ...
                            <div id="content" class="village2" style="font-size: 9pt;">
                                <img class="building g40 g40_5 <?= $tribeCss ?>" src="img/x.gif" align="right"
                                    title="" />
                                <p style="width:90%">
                                    <b><?= $lang_winner['1']; ?>,</b>
                                    ...
                                    "<a href="spieler.php?uid=<?php echo $datas[0]['userid']; ?>"
                                        title="<?= $lang_winner['desc1']; ?>: <?php echo $datas[0]['totalvillages'];
                                          echo "\n"; ?><?= $lang_winner['desc2']; ?>: <?php echo $datas[0]['totalpop']; ?>"><?php echo $datas[0]['username']; ?></a>"
                                    <?= $lang_winner['8']; ?> "<a
                                        href="spieler.php?uid=<?php echo $datas[1]['userid']; ?>"
                                        title="<?= $lang_winner['desc1']; ?>: <?php echo $datas[1]['totalvillages'];
                                          echo "\n"; ?><?= $lang_winner['desc2']; ?>: <?php echo $datas[1]['totalpop']; ?>"><?php echo $datas[1]['username']; ?></a>"
                                    <?= $lang_winner['9']; ?> "<a
                                        href="spieler.php?uid=<?php echo $datas[2]['userid']; ?>"
                                    ...
                                    "<a href="spieler.php?uid=<?php echo $attacker[0]['userid']; ?>"
                                        title="<?= $lang_winner['desc3']; ?>: <?php echo $attacker[0]['apall']; ?>"><?php echo $attacker[0]['username']; ?></a>"
                                    <?= $lang_winner['10']; ?><br />
                                    "<a href="spieler.php?uid=<?php echo $defender[0]['userid']; ?>"
                                        title="<?= $lang_winner['desc4']; ?>: <?php echo $defender[0]['dpall']; ?>"><?php echo $defender[0]['username']; ?></a>"
                                    <?= $lang_winner['11']; ?>
