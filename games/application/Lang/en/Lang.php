...
define("IEFF115", "+500 to hero strength For every Slave Militia: +3 attack and +3 defence");
define("ITEM116", "Scepter stick marsha fluffy");
define("IEFF116", "+1000 to hero strength For every Slave Militia: +4 attack and +4 defence");
define("ITEM117", "Fluff mulcha star");
define("IEFF117", "+1500 to hero strength For every Slave Militia: +5 attack and +5 defence");
define("ITEM118", "Ash guard axe");
define("IEFF118", "+500 to hero strength For every Ash Warden: +3 attack and +3 defence");
define("ITEM119", "Ash guard better axe");
define("IEFF119", "+1000 to hero strength For every Ash Warden: +4 attack and +4 defence");
define("ITEM120", "Ashes guard war axe");
define("IEFF120", "+1500 to hero strength For every Ash Warden: +5 attack and +5 defence");
